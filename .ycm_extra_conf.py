...
PlatformioArduinoLibs = "~/.platformio/packages/framework-arduino-avr/libraries/"
...
PlatformioArduinoCore = "~/.platformio/packages/framework-arduino-avr/cores/arduino/"
...
PlatformLocal = os.path.join(os.path.curdir, ".pio/libdeps/uno/Servo/src/")
